      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center gap-4">
            <a className="text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white transition-colors" href="https://github.com/Joydeep279/internals">
            ...
            <button
              onClick={toggleTheme}
              className="bg-transparent text-slate-500 dark:text-slate-400 hover:text-amber-500 dark:hover:text-yellow-400 transition-colors"
